...
describe("Tuple fromArray", () => {
  ...
  test("fromArray (failure on long array)", () => expect(Tuple.fromArray([0, 1, 2]))->toEqual(None))

  test("fromArray3 (success)", () => expect(Tuple.fromArray3([0, 1, 2]))->toEqual(Some((0, 1, 2))))

  test("fromArray3 (failure on short array)", () => expect(Tuple.fromArray3([0, 1]))->toEqual(None))
...
describe("Tuple fromArrayAtLeast", () => {
  ...
  test("fromArrayAtLeast5", () =>
    expect(Tuple.fromArrayAtLeast5(Array.repeat(6, "A")))->toEqual(Some(("A", "A", "A", "A", "A")))
  )
})
...
describe("Tuple apply", () => {
  test("apply2", () => expect((1, 2)->(Tuple.apply2((a, b) => a + b, _)))->toEqual(3))

  test("apply3", () => expect((1, 2, 3)->(Tuple.apply3((a, b, c) => a + b + c, _)))->toEqual(6))

  test("apply4", () =>
    expect((1, 2, 3, 4)->(Tuple.apply4((a, b, c, d) => a + b + c + d, _)))->toEqual(10)
  )

  test("apply5", () =>
    expect((1, 2, 3, 4, 5)->(Tuple.apply5((a, b, c, d, e) => a + b + c + d + e, _)))->toEqual(15)
  )
})
...
describe("Tuple WithEqs", () => {
  ...
  test("WithEqs4", () => expect(Eq4.eq((42, "hi", true, ()), (42, "hi", true, ())))->toEqual(true))
...
module User = {
  ...
  module EqBy5 = Tuple5.EqBy(
    ...
    Bool.Eq,
    {
      ...
      let f = user => (user.first, user.last, user.age, user.email, user.approved)
    },
  )
...
describe("Tuple compareBy", () => {
  test("compareBy2", () =>
    expect(Tuple.compareBy2(String.compare, Int.compare, ("a", 42), ("a", 43)))->toEqual(#less_than)
  )
...
describe("Tuple WithOrds", () => {
  ...
  test("WithOrds5", () =>
    expect(Ord5.compare((42, "hi", true, (), 99.9), (42, "hi", true, (), 99.9)))->toEqual(#equal_to)
  )
})

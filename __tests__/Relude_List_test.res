...
describe("List", () => {
  ...
  test("take non-zero from equal list", () => expect(List.take(2, list{1, 2}))->toEqual(list{1, 2}))

  test("take non-zero from long list", () =>
    expect(List.take(2, list{1, 2, 3}))->toEqual(list{1, 2})
  )

  test("takeExactly negative from list", () => expect(List.takeExactly(-2, list{}))->toEqual(None))
  ...
  test("drop zero from nonempty list", () => expect(List.drop(0, list{1, 2}))->toEqual(list{1, 2}))
  ...
  test("removeFirstBy empty", () => expect(List.removeFirstBy(Int.eq, 0, list{}))->toEqual(list{}))
  ...
  test("apply", () =>
    expect(List.apply(list{a => a + 2, a => a * 3}, list{1, 2, 3}))->toEqual(list{3, 4, 5, 3, 6, 9})
  )
  ...
  test("map4", () =>
    ...
    )->toEqual(list{114, 214, 124, 224, 115, 215, 125, 225, 115, 215, 125, 225, 116, 216, 126, 226})
  )
  ...
  test("String.sort", () =>
    expect(List.String.sort(list{"c", "d", "a", "b", "c"}))->toEqual(list{"a", "b", "c", "c", "d"})
  )

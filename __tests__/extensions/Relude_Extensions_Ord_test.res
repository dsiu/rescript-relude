...
module User = {
  ...
  module EqByName: EQ with type t = t = String.EqBy({
    type a = t
    type b = string
    let f = getName
  })

  module EqByAge: EQ with type t = t = Int.EqBy({
    type a = t
    type b = int
    let f = getAge
  })

  module EqByNameAndAge: EQ with type t = t = Tuple.Tuple2.EqBy(
    String.Eq,
    Int.Eq,
    {
      type a = t
  ...
  module OrdByName: ORD with type t = t = String.OrdBy({
    type a = t
    type b = string
    let f = getName
  })

  module OrdByAge: ORD with type t = t = Int.OrdBy({
    type a = t
    type b = int
    let f = getAge
  })
  ...
  module OrdByNameThenAge2: ORD with type t = t = Tuple.Tuple2.OrdBy(
    String.Ord,
    Int.Ord,
    {
...
let users1 = list{user1, user2, user3, user4, user5, user6}
let users2 = list{user5, user1, user3, user4, user6, user2}

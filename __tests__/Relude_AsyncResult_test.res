...
module AsyncResultS = AsyncResult.WithError({
  type t = string
})

describe("AsyncResult", () => {
  test("Init", () => expect(AsyncResult.init) -> toEqual(AsyncData.init))

  test("Loading", () => expect(AsyncResult.loading) -> toEqual(AsyncData.loading))

  test("Complete Ok", () => expect(AsyncResult.ok(1)) -> toEqual(AsyncData.complete(Ok(1))))

  test("Complete Error", () =>
    expect(AsyncResult.error("Fail")) -> toEqual(AsyncData.complete(Error("Fail")))
  )
  ...
  test("isReloadingOk when Complete Error", () =>
    expect({
      open AsyncResult
      completeError("fail") |> isReloadingOk
    }) -> toEqual(false)
  )
  ...
  test("isReloadingError when Reloading Ok", () =>
    expect({
      open AsyncResult
      reloadingOk(1) |> isReloadingError
    }) -> toEqual(false)
  )
  ...
  test("isReloadingError when Reloading Error", () =>
    expect({
      open AsyncResult
      reloadingError("fail") |> isReloadingError
    }) -> toEqual(true)
  )
  ...
  test("isCompleteOk when Complete Error", () =>
    expect({
      open AsyncResult
      completeError("fail") |> isCompleteOk
    }) -> toEqual(false)
  )
  ...
  test("isCompleteError when Complete Error", () =>
    expect({
      open AsyncResult
      completeError("fail") |> isCompleteError
    }) -> toEqual(true)
  )
  ...
  test("getCompleteError when Reloading Error", () =>
    expect({
      open AsyncResult
      reloadingError("fail") |> getCompleteError
    }) -> toEqual(None)
  )
  ...
  test("getReloadingError when Complete Error", () =>
    expect({
      open AsyncResult
      completeError("fail") |> getReloadingError
    }) -> toEqual(None)
  )
  ...
  test("getReloadingError when Reloading Error", () =>
    expect({
      open AsyncResult
      reloadingError("fail") |> getReloadingError
    }) -> toEqual(Some("fail"))
  )

  test("map Init", () =>
    expect(AsyncResult.init |> AsyncResult.map(i => i + 1)) -> toEqual(AsyncResult.init)
  )

  test("map Loading", () =>
    expect(AsyncResult.loading |> AsyncResult.map(i => i + 1)) -> toEqual(AsyncResult.loading)
  )

  test("map Reloading Ok", () =>
    expect(AsyncResult.reloadingOk(42) |> AsyncResult.map(i => i + 1)) -> toEqual(
      AsyncResult.reloadingOk(43),
    )
  )

  test("map Reloading Error", () =>
    expect(AsyncResult.reloadingError(42) |> AsyncResult.map(i => i + 1)) -> toEqual(
      AsyncResult.reloadingError(42),
    )
  )

  test("map Complete Ok", () =>
    expect(AsyncResult.completeOk(42) |> AsyncResult.map(i => i + 1)) -> toEqual(
      AsyncResult.completeOk(43),
    )
  )

  test("map Complete Error", () =>
    expect(AsyncResult.completeError(42) |> AsyncResult.map(i => i + 1)) -> toEqual(
      AsyncResult.completeError(42),
    )
  )

  test("mapError Init", () =>
    expect(AsyncResult.init |> AsyncResult.mapError(i => i + 1)) -> toEqual(AsyncResult.init)
  )

  test("mapError Loading", () =>
    expect(AsyncResult.loading |> AsyncResult.mapError(i => i + 1)) -> toEqual(AsyncResult.loading)
  )

  test("mapError Reloading Ok", () =>
    expect(AsyncResult.reloadingOk(42) |> AsyncResult.mapError(i => i + 1)) -> toEqual(
      AsyncResult.reloadingOk(42),
    )
  )

  test("mapError Reloading Error", () =>
    expect(AsyncResult.reloadingError(42) |> AsyncResult.mapError(i => i + 1)) -> toEqual(
      AsyncResult.reloadingError(43),
    )
  )

  test("mapError Complete Ok", () =>
    expect(AsyncResult.completeOk(42) |> AsyncResult.mapError(i => i + 1)) -> toEqual(
      AsyncResult.completeOk(42),
    )
  )

  test("mapError Complete Error", () =>
    expect(AsyncResult.completeError(42) |> AsyncResult.mapError(i => i + 1)) -> toEqual(
      AsyncResult.completeError(43),
    )
  )

  test("eqBy different constructors", () =>
    expect(
      AsyncResult.eqBy((_, _) => true, (_, _) => true, AsyncResult.init, AsyncResult.loading),
    ) -> toEqual(false)
  )

  test("eqBy same success value", () =>
    expect(
      AsyncResult.eqBy(Relude.String.eq, Relude.Int.eq, AsyncResult.ok(1), AsyncResult.ok(1)),
    ) -> toEqual(true)
  )
  ...
  test("tapByValue reloadingOk", () => {
    let count = ref(0)
    let f = a => count := count.contents + (a |> Result.getOk |> Option.getOrElse(-1)) + 1
    AsyncResult.reloadingOk(10) |> AsyncResult.tapByValue(() => (), f) |> ignore
    expect(count.contents) -> toEqual(11)
  })

  test("tapByValue reloadingError", () => {
    let count = ref(0)
    let f = a => count := count.contents + (a |> Result.getError |> Option.getOrElse(-1)) + 1
    AsyncResult.reloadingError(10) |> AsyncResult.tapByValue(() => (), f) |> ignore
    expect(count.contents) -> toEqual(11)
  })
  ...
  test("tapByValue completeOk", () => {
    let count = ref(0)
    let f = a => count := count.contents + (a |> Result.getOk |> Option.getOrElse(-1)) + 1
    AsyncResult.completeOk(10) |> AsyncResult.tapByValue(() => (), f) |> ignore
    expect(count.contents) -> toEqual(11)
  })
  ...
  test("tapByValue completeError", () => {
    let count = ref(0)
    let f = a => count := count.contents + (a |> Result.getError |> Option.getOrElse(-1)) + 1
    AsyncResult.completeError(10) |> AsyncResult.tapByValue(() => (), f) |> ignore
    expect(count.contents) -> toEqual(11)
  })
  ...
  test("apply Init & Init = Init", () =>
    ( AsyncResult.apply(AsyncResult.init, AsyncResult.init) ) -> expect -> toEqual(AsyncResult.init)
  )
  ...
  test("apply Loading & Reloading Error = Reloading Error", () =>
    ( AsyncResult.apply(AsyncResult.loading, AsyncResult.reloadingError("error")) )
    -> expect
    -> toEqual(AsyncResult.reloadingError("error"))
  )
  ...
  test("apply Loading & Complete Error = Complete Error", () =>
    ( AsyncResult.apply(AsyncResult.loading, AsyncResult.completeError("error")) )
    -> expect
    -> toEqual(AsyncResult.completeError("error"))
  )
  ...
  test("apply Reloading Ok & Loading = Loading", () =>
    ( AsyncResult.apply(AsyncResult.reloadingOk(() => "ok"), AsyncResult.loading) )
    -> expect
    -> toEqual(AsyncResult.loading)
  )

  test("apply Reloading Error & Loading = Reloading Error", () =>
    ( AsyncResult.apply(AsyncResult.reloadingError("error"), AsyncResult.loading) )
    -> expect
    -> toEqual(AsyncResult.reloadingError("error"))
  )

  test("apply Reloading Ok & Reloading Ok = Reloading Ok", () =>
    ( AsyncResult.apply(AsyncResult.reloadingOk(r => r ++ "ok"), AsyncResult.reloadingOk("ok")) )
    -> expect
    -> toEqual(AsyncResult.reloadingOk("okok"))
  )

  test("apply Reloading Ok & Reloading Error = Reloading Error", () =>
    ( AsyncResult.apply(AsyncResult.reloadingOk(() => "ok"), AsyncResult.reloadingError("error")) )
    -> expect
    -> toEqual(AsyncResult.reloadingError("error"))
  )

  test("apply Reloading Error & Reloading Ok = Reloading Error", () =>
    ( AsyncResult.apply(AsyncResult.reloadingError("error"), AsyncResult.reloadingOk("ok")) )
    -> expect
    -> toEqual(AsyncResult.reloadingError("error"))
  )

  test("apply Reloading Error & Reloading Error = Reloading Error", () =>
    ( AsyncResult.apply(AsyncResult.reloadingError("error"), AsyncResult.reloadingError("error_2")) )
    -> expect
    -> toEqual(AsyncResult.reloadingError("error"))
  )

  test("apply Reloading Ok & Complete Ok = Reloading Ok", () =>
    ( AsyncResult.apply(AsyncResult.reloadingOk(r => r ++ "ok"), AsyncResult.completeOk("ok")) )
    -> expect
    -> toEqual(AsyncResult.reloadingOk("okok"))
  )

  test("apply Reloading Ok & Complete Error = Complete Erro", () =>
    ( AsyncResult.apply(AsyncResult.reloadingOk(r => r ++ "ok"), AsyncResult.completeError("error")) )
    -> expect
    -> toEqual(AsyncResult.completeError("error"))
  )

  test("apply Reloading Error & Complete Ok = Reloading Error", () =>
    ( AsyncResult.apply(AsyncResult.reloadingError("error"), AsyncResult.completeOk("ok")) )
    -> expect
    -> toEqual(AsyncResult.reloadingError("error"))
  )

  test("apply Reloading Error & Complete Error = Reloading Error", () =>
    ( AsyncResult.apply(AsyncResult.reloadingError("error"), AsyncResult.completeError("error_2")) )
    -> expect
    -> toEqual(AsyncResult.reloadingError("error"))
  )
  ...
  test("apply Complete Error & Loading = Complete Error", () =>
    ( AsyncResult.apply(AsyncResult.completeError("error"), AsyncResult.loading) )
    -> expect
    -> toEqual(AsyncResult.completeError("error"))
  )

  test("apply Complete Ok & Reloading Ok = Reloading Ok", () =>
    ( AsyncResult.apply(AsyncResult.completeOk(r => r ++ "ok"), AsyncResult.reloadingOk("ok")) )
    -> expect
    -> toEqual(AsyncResult.reloadingOk("okok"))
  )

  test("apply Complete Ok & Reloading Error = Reloading Error", () =>
    ( AsyncResult.apply(AsyncResult.completeOk(r => r ++ "ok"), AsyncResult.reloadingError("error")) )
    -> expect
    -> toEqual(AsyncResult.reloadingError("error"))
  )

  test("apply Complete Error & Reloading Ok = Complete Error", () =>
    ( AsyncResult.apply(AsyncResult.completeError("error"), AsyncResult.reloadingOk("ok")) )
    -> expect
    -> toEqual(AsyncResult.completeError("error"))
  )

  test("apply Complete Error & Reloading Error = Complete Error", () =>
    ( AsyncResult.apply(AsyncResult.completeError("error"), AsyncResult.reloadingError("error_2")) )
    -> expect
    -> toEqual(AsyncResult.completeError("error"))
  )

  test("apply Complete Ok & Complete Ok = Complete Ok", () =>
    ( AsyncResult.apply(AsyncResult.completeOk(r => r ++ "ok"), AsyncResult.completeOk("ok")) )
    -> expect
    -> toEqual(AsyncResult.completeOk("okok"))
  )

  test("apply Complete Ok & Complete Error = Complete Error", () =>
    ( AsyncResult.apply(AsyncResult.completeOk(r => r ++ "ok"), AsyncResult.completeError("error")) )
    -> expect
    -> toEqual(AsyncResult.completeError("error"))
  )

  test("apply Complete Error & Complete Ok = Complete Error", () =>
    ( AsyncResult.apply(AsyncResult.completeError("error"), AsyncResult.completeOk("ok")) )
    -> expect
    -> toEqual(AsyncResult.completeError("error"))
  )

  test("apply Complete Error & Complete Error = Complete Error", () =>
    ( AsyncResult.apply(AsyncResult.completeError("error"), AsyncResult.completeError("error_2")) )
    -> expect
    -> toEqual(AsyncResult.completeError("error"))
  )
  ...
  test("bind Reloading Ok", () =>
    ( AsyncResult.bind(AsyncResult.reloadingOk(1), a => AsyncResult.reloadingError(a + 1)) )
    -> expect
    -> toEqual(AsyncResult.reloadingError(2))
  )

  test("bind Reloading Error", () =>
    ( AsyncResult.bind(AsyncResult.reloadingError(1), a => AsyncResult.reloadingOk(a + 1)) )
    -> expect
    -> toEqual(AsyncResult.reloadingError(1))
  )

  test("bind Complete Ok", () =>
    ( AsyncResult.bind(AsyncResult.completeOk(1), a => AsyncResult.completeError(a + 1)) )
    -> expect
    -> toEqual(AsyncResult.completeError(2))
  )

  test("bind Complete Error", () =>
    ( AsyncResult.bind(AsyncResult.completeError(1), a => AsyncResult.completeOk(a + 1)) )
    -> expect
  ...
  test("flatten Init", () =>
    ( AsyncResult.init |> AsyncResult.flatten ) -> expect -> toEqual(AsyncResult.init)
  )

  test("flatten Loading", () =>
    ( AsyncResult.loading |> AsyncResult.flatten ) -> expect -> toEqual(AsyncResult.loading)
  )
  ...
  test("alt (Init, Init)", () => {
    open AsyncResult
    alt(Init, Init) -> expect -> toEqual(init)
  })

  test("alt (Init, Loading)", () => {
    open AsyncResult
    alt(Init, Loading) -> expect -> toEqual(loading)
  })

  test("alt (Init, Reloading(Error))", () => {
    open AsyncResult
    alt(Init, Reloading(Error(0))) -> expect -> toEqual(init)
  })
  ...
  test("alt (Init, Complete(Error))", () => {
    open AsyncResult
    alt(Init, Complete(Error(0))) -> expect -> toEqual(init)
  })
  ...
  test("alt (Loading, Init)", () => {
    open AsyncResult
    alt(Loading, Init) -> expect -> toEqual(loading)
  })

  test("alt (Reloading(Error), Init)", () => {
    open AsyncResult
    alt(Reloading(Error(1)), Init) -> expect -> toEqual(init)
  })
  ...
  test("alt (Reloading(Error), Reloading(Error))", () => {
    open AsyncResult
    alt(Reloading(Error(1)), Reloading(Error(2))) -> expect -> toEqual(reloadingError(1))
  })

  test("alt (Reloading(Error), Complete(Error))", () => {
    open AsyncResult
    alt(Reloading(Error(1)), Complete(Error(2))) -> expect -> toEqual(completeError(2))
  })

  test("alt (Complete(Error), Init)", () => {
    open AsyncResult
    alt(Complete(Error(1)), Init) -> expect -> toEqual(init)
  })
  ...
  test("alt (Complete(Error), Reloading(Error))", () => {
    open AsyncResult
    alt(Complete(Error(1)), Reloading(Error(2))) -> expect -> toEqual(completeError(1))
  })

  test("alt (Complete(Error), Reloading(Ok))", () => {
    open AsyncResult
    alt(Complete(Error(1)), Reloading(Ok(2))) -> expect -> toEqual(reloadingOk(2))
  })

  test("alt (Complete(Error), Complete(Error))", () => {
    open AsyncResult
    alt(Complete(Error(1)), Complete(Error(2))) -> expect -> toEqual(completeError(1))
  })

  test("fromAsyncData Init", () =>
    ( AsyncData.init |> AsyncResult.fromAsyncData ) -> expect -> toEqual(AsyncResult.init)
  )

  test("fromAsyncData Loading", () =>
    ( AsyncData.loading |> AsyncResult.fromAsyncData ) -> expect -> toEqual(AsyncResult.loading)
  )
  ...
  test("toAsyncData Init", () =>
    ( AsyncResult.init |> AsyncResult.toAsyncData ) -> expect -> toEqual(AsyncData.init)
  )

  test("toAsyncData Loading", () =>
    ( AsyncResult.loading |> AsyncResult.toAsyncData )-> expect -> toEqual(AsyncData.loading)
  )

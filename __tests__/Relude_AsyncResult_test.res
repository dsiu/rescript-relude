...
describe("AsyncResult", () => {
  ...
  test("map Init", () =>
    expect(AsyncResult.init->(AsyncResult.map(i => i + 1, _)))->toEqual(AsyncResult.init)
  )

  test("map Loading", () =>
    expect(AsyncResult.loading->(AsyncResult.map(i => i + 1, _)))->toEqual(AsyncResult.loading)
  )

  test("map Reloading Ok", () =>
    expect(AsyncResult.reloadingOk(42)->(AsyncResult.map(i => i + 1, _)))->toEqual(
      AsyncResult.reloadingOk(43),
    )
  )

  test("map Reloading Error", () =>
    expect(AsyncResult.reloadingError(42)->(AsyncResult.map(i => i + 1, _)))->toEqual(
      AsyncResult.reloadingError(42),
    )
  )

  test("map Complete Ok", () =>
    expect(AsyncResult.completeOk(42)->(AsyncResult.map(i => i + 1, _)))->toEqual(
      AsyncResult.completeOk(43),
    )
  )

  test("map Complete Error", () =>
    expect(AsyncResult.completeError(42)->(AsyncResult.map(i => i + 1, _)))->toEqual(
      AsyncResult.completeError(42),
    )
  )

  test("mapError Init", () =>
    expect(AsyncResult.init->(AsyncResult.mapError(i => i + 1, _)))->toEqual(AsyncResult.init)
  )

  test("mapError Loading", () =>
    expect(AsyncResult.loading->(AsyncResult.mapError(i => i + 1, _)))->toEqual(AsyncResult.loading)
  )

  test("mapError Reloading Ok", () =>
    expect(AsyncResult.reloadingOk(42)->(AsyncResult.mapError(i => i + 1, _)))->toEqual(
      AsyncResult.reloadingOk(42),
    )
  )

  test("mapError Reloading Error", () =>
    expect(AsyncResult.reloadingError(42)->(AsyncResult.mapError(i => i + 1, _)))->toEqual(
      AsyncResult.reloadingError(43),
    )
  )

  test("mapError Complete Ok", () =>
    expect(AsyncResult.completeOk(42)->(AsyncResult.mapError(i => i + 1, _)))->toEqual(
      AsyncResult.completeOk(42),
    )
  )

  test("mapError Complete Error", () =>
    expect(AsyncResult.completeError(42)->(AsyncResult.mapError(i => i + 1, _)))->toEqual(
